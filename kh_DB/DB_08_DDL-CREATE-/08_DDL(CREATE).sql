...
-- DML(Date Manipulation Language) : 데이터 조작 언어. 테이블의 데이터를 삽입, 수정, 삭제하는 언어
 ...
 * 
 * VARCHAR2(크기) : 가번길이 문자형(4000 BYTE)
 * --> EX) VARCHAR2(10) 컬럼에 'ABC' 3BYTE 문자열만 저장하면 나머지 7BYTE를 반환
 * 
 * DATE : 날짜 타입
 * 
 * BLOB : 대용량 이진 데이터(4GB)
...
-- 추가 샘플 데이터 삽입
INSERT INTO "MEMBER"  VALUES('MEM02', 'PW02', '고길동', '000101=1234567', SYSDATE);
INSERT INTO "MEMBER" VALUES('MEM03', 'PW03', '이몽룡', '000202=1234567', DEFAULT);

COMMIT;

-- INSERT 시 미작성 하는 경우(가입일) DEFAULT 값이 반영된다
...
-- '2023-01-13 10:33:27'
INSERT INTO "MEMBER" VALUES('MEM05', 'PW05', '김준수', '121212-1234567', TO_DATE('2023-01-13 10:33:27', 'YYYY-MM-DD HH24:MI:SS'));
...
INSERT INTO MEMBER2 VALUES('MEM01', 'PW01', '이현경', 7712341234);
INSERT INTO MEMBER2 VALUES('MEM02', 'PW02', '최정오', 01012341234);
...
-- * 컬렘레벨? : 테이블 생성 시 컬럼을 정의하는 부분에 작성하는 것
...
VALUES (1, 'USER01', 'PASS01', '홍길동', '남', '010-1234-1234', 'Hong@kh.or.kr');
...
VALUES(1, 'USER01', 'PW01', '홍길동', '남', '010-1234-5678', 'HONG@KH.OR.KR');
INSERT INTO USER_USED_UK
VALUES(1, 'USER01', 'PW01', '홍길동', '남', '010-1234-5678', 'HONG@KH.OR.KR');
-- SQL Error [1] [23000]: ORA-00001: 무결성 제약 조건(KH.SYS_C008405)에 위배됩니다

INSERT INTO USER_USED_UK
VALUES(1, 'USER02', 'PW01', '홍길동', '남', '010-1234-5678', 'HONG@KH.OR.KR');

-- NULL 넣어보기
INSERT INTO USER_USED_UK
VALUES(1, NULL, 'PW01', '홍길동', '남', '010-1234-5678', 'HONG@KH.OR.KR');
--> 아이디에 NULL값 삽입 가능, NULL은 중복 가능
...
-- ID가 다름
INSERT INTO USER_USED_UK2
VALUES(2, 'USER02', 'PW01', '홍길동', '남', '010-1234-5678', 'HONG@KH.OR.KR');

-- 이름이 다름
INSERT INTO USER_USED_UK2
VALUES(1, 'USER01', 'PW01', '고길동', '남', '010-1234-5678', 'HONG@KH.OR.KR');
...
INSERT INTO USER_USED_PK2
VALUES(1, 'USER02', 'PW02', '고길동', '남', '010-2345-6789', 'KO@KH.OR.KR');
-- SQL Error [1] [23000]: ORA-00001: 무결성 제약 조건(KH.USER_NO_PK)에 위배됩니다

INSERT INTO USER_USED_PK2
VALUES(2, 'USER02', 'PW02', '고길동', '남', '010-2345-6789', 'KO@KH.OR.KR');

INSERT INTO USER_USED_PK2
VALUES(NULL, 'USER02', 'PW02', '고길동', '남', '010-2345-6789', 'KO@KH.OR.KR');
-- ORA-01400: NULL을 ("KH"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다


--------------------------------------------------------------------------------------------------------

-- 4. FREIGN KEY(외부키/외래키) 제약조건

-- 참조된 다른 테이블의 컬럼이 제공하는 값만 사용할 수 있음
-- FREIGN KEY 제약조건에 의해서 테이블간에 관계가 형성됨
...
-- 테이블레벨일 경우
-- [CONSTRAINT 이름] FORIGN KEY (적용할 컬럼명) REFERENCES 참조할테이블명 [(참조할컬럼)] [삭제룰] 
...
CREATE TABLE USER_USED_FK(
	...
	PHONE VARCHAR2(30),
	EMAIL VARCHAR2(50),
	GARDE_CODE NUMBER CONSTRAINT GRADE_CODE_FK REFERENCES USER_GRADE /*(GRADE_CODE)*/
...
VALUES(1, 'USER01', 'PASS01', '홍길동', '남', '010-1234-5678', 'HON@KH.OR.KR', 10);

INSERT INTO USER_USED_FK
VALUES(2, 'USER02', 'PASS02', '이순신', '남', '010-1111-2222', 'LEE@KH.OR.KR', 20);

INSERT INTO USER_USED_FK
VALUES(3, 'USER03', 'PASS03', '유관순', '여', '010-3333-4444', 'YOO@KH.OR.KR', 30);

INSERT INTO USER_USED_FK
VALUES(4, 'USER04', 'PASS04', '안중근', '남', '010-5555-6666', 'AHN@KH.OR.KR', NULL);

INSERT INTO USER_USED_FK
VALUES(5, 'USER05', 'PASS05', '윤봉길', '남', '010-7777-8888', 'YOON@KH.OR.KR', 50);
...
/*
UPDATE USER_USED_FK SET GARDE_CODE = 30
WHERE GARDE_CODE = 20;
*/
...
CREATE TABLE USER_USED_FK2(
	...
	PHONE VARCHAR2(30),
	EMAIL VARCHAR2(50),
	GARDE_CODE NUMBER CONSTRAINT GRADE_CODE_FK2 REFERENCES USER_GRADE2 ON DELETE SET NULL
);
...
INSERT INTO USER_USED_FK2
VALUES(2, 'USER02', 'PASS02', '이순신', '남', '010-1111-2222', 'LEE@KH.OR.KR', 10);
...
-- CHECK (컬럼명 비교연산자 비교값)
-- 주의할 점 : 비교값은 리터럴만 사용할 수 있음, 변하는 값 or 함수 사용 못함
...
VALUES(1, 'USER01', 'PASS01', '홍길동', '남', '010-1234-1234', 'HONG@TEST.KH.OR');

SELECT * FROM USER_USED_CHECK;

INSERT INTO USER_USED_CHECK
VALUES(1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-1234', 'HONG@TEST.KH.OR');
-- ORA-02290: 체크 제약조건(KH.GENDER_CHECK)이 위배되었습니다
-- CHECK 제약조건으로 GENDER 컬럼을 설정했기 때문에, 남 또는 여 만 기록 가능한데
-- 남자라는 조건 이외값이 들어와 에러 발생
...
-- 다른 제약조건, 코멘트는 복사되지 않기 때문에 별도 추가 작업이 필요하다
...
ALTER TABLE EMPLOYEE ADD CONSTRAINT FK_EMP_COPY2 
...
ALTER TABLE EMPLOYEE ADD CONSTRAINT EMP_JOB_CODE2
...
ALTER TABLE LOCATION ADD CONSTRAINT EMP_NAT_CODE
