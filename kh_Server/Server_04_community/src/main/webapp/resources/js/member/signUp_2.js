...
document.getElementById("memberEmail").addEventListener("keyup", function() {
    ...
    if(regEx.test(inputEmail.value)){
        document.getElementById("emailMessage").classList.add("confirm");
        document.getElementById("emailMessage").classList.remove("error");
        document.getElementById("emailMessage").innerText = "양식 일치";
    } else{
        document.getElementById("emailMessage").classList.remove("confirm");
        document.getElementById("emailMessage").classList.add("error");
        document.getElementById("emailMessage").innerText = "양식 불일치";
    }
})
