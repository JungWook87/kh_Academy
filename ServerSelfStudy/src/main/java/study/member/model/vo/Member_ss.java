package study.member.model.vo;

public class Member_ss {
	...
	public Member_ss(int memberNo, String memberEmail, String memberPw, String memberNickname, String memberTel,
