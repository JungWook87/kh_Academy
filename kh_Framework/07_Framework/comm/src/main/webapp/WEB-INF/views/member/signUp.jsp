        ...
        <jsp:include page="/WEB-INF/views/common/header.jsp" />
         ...
         <section class="signUp-content">
            ...
            <form action="signUp" method="POST" name="signUp-form" onsubmit="return signUpValidate()">
                 ...
                 <div class="signUp-input-area">
                     <input type="text" name="memberAddress" id="memberAddress_address" placeholder="도로명주소">
                 </div>
 
                 <div class="signUp-input-area">
                     <input type="text" name="memberAddress" id="memberAddress_detailAddress" placeholder="상세주소">
                 </div>
        ...
        function sample6_execDaumPostcode() {
            new daum.Postcode({
                oncomplete: function(data) {
                    ...
                    document.getElementById("memberAddress_address").value = addr;
                    // 커서를 상세주소 필드로 이동한다.
                    document.getElementById("memberAddress_detailAddress").focus();
                }
            }).open();
        }
    </script>
