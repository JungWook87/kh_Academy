...
public class JDBCExample {
	public static void main(String[] args) {
		...
		try {
			...
			// --> 생략해도 자동으로 메로리 로드가 진행됨(명시적으로 작성하는걸 권장)
			
			
			// 2) 연결 정보를 담을 Connection을 생성
			...
			// 본인 ip 주소 찾는법 cmd 창에서 ipconfig 치고, IPv4 주소
			...
			// excecuteQuery() : SELECT문 수행 메서드, ResultSet 반환
			...
			while(rs.next()) {
				...
				// java.sql.Date의 toString()은 yyyy-mm-dd 형식을 오버라이딩 되어 있음.
